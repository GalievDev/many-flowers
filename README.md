...
## About
![Many Flowers](./assets/all_flowers.png)
...
![Floral Meal](./assets/floral_meal.png)
...
![Advancements](./assets/advancements.png)

## Doubling ores
Get petals from ore crop block

![Ore flowers](./assets/ore_flowers.png)

Crop blocks can be grew only by Floral Meal

| ![Petal block](./assets/petal_block.png) | ![Double ore](./assets/double_ore.png) |
|------------------------------------------|----------------------------------------|