...
class ModModelProvider(output: FabricDataOutput) : FabricModelProvider(output) {
    ...
    override fun generateBlockStateModels(generator: BlockStateModelGenerator) {
        ...
        registerFlowerWithItem(generator, BlocksRegistry.BLACK_EYED_SUSAN, CrossType.NOT_TINTED)
        registerFlowerWithItem(generator, BlocksRegistry.COREOPSIS, CrossType.NOT_TINTED)
        registerFlowerWithItem(generator, BlocksRegistry.DAHLIA, CrossType.NOT_TINTED)
        registerFlowerWithItem(generator, BlocksRegistry.LAVENDER, CrossType.NOT_TINTED)
