...
public class ItemsReg {
    ...
    public static final Item DIAMOND_SEEDS = registerItem("diamond_seeds",
            new AliasedBlockItem(DIAMOND_PLANT, new FabricItemSettings().group(ItemGroupSetup.MANY_FLOWERS)));

    public static final Item COAL_SEEDS = registerItem("coal_seeds",
            new AliasedBlockItem(COAL_PLANT, new FabricItemSettings().group(ItemGroupSetup.MANY_FLOWERS)));

    public static final Item IRON_SEEDS = registerItem("iron_seeds",
            new AliasedBlockItem(IRON_PLANT, new FabricItemSettings().group(ItemGroupSetup.MANY_FLOWERS)));

    public static final Item GOLD_SEEDS = registerItem("gold_seeds",
            new AliasedBlockItem(GOLD_PLANT, new FabricItemSettings().group(ItemGroupSetup.MANY_FLOWERS)));

    public static final Item EMERALD_SEEDS = registerItem("emerald_seeds",
            new AliasedBlockItem(EMERALD_PLANT, new FabricItemSettings().group(ItemGroupSetup.MANY_FLOWERS)));

    public static final Item COPPER_SEEDS = registerItem("copper_seeds",
            new AliasedBlockItem(COPPER_PLANT, new FabricItemSettings().group(ItemGroupSetup.MANY_FLOWERS)));

    //Items//
    public static final Item DIAMOND_PETAL = registerItem("diamond_petal",
            new Item(new Item.Settings().group(ItemGroupSetup.MANY_FLOWERS)));
