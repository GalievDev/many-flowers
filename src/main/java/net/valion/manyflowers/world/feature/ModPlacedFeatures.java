...
public class ModPlacedFeatures {
    ...
    public static void bootstrap(Registerable<PlacedFeature> context) {
        ...
        register(context, ALSTROEMERIA_FLOWER_PLACED,
        ...
        register(context, HYDRANGEA_FLOWER_PLACED,
        ...
        register(context, MARIGOLD_FLOWER_PLACED,
        ...
        register(context, DAISIES_PLACED,
        ...
        register(context, ALYSSUM_FLOWER_PLACED,
        ...
        register(context, GAILLARDIA_PLACED,
        ...
        register(context, OENOTHERA_PLACED,
        ...
        register(context, CHRYSANTHEMUM_PLACED,
        ...
        PlacedFeatures.register(context, AUTUMN_CROCUS,
                configuredFeatureRegistryEntryLookup.getOrThrow(ModConfiguredFeatures.AUTUMN_CROCUS),
        ...
        register(context, AUTUMN_ASTERS,
        ...
        register(context, COAL_FLOWER_PLACED,
        ...
        register(context, COPPER_FLOWER_PLACED,
        ...
        register(context, IRON_FLOWER_PLACED,
        ...
        register(context, GOLD_FLOWER_PLACED,
        ...
        register(context, DIAMOND_FLOWER_PLACED,
        ...
        register(context, EMERALD_FLOWER_PLACED,
        ...
        register(context, WORLDS_ROOT_PLACED,
